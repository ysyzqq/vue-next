...
>(
  ...
  function processText(
    ...
    if (n1 == null) {
      // 创建元素的方法都由options传入, 可以适配除了dom以外的其他环境
      hostInsert(
  ...
  function setupRenderEffect(
    ...
    // create reactive effect for rendering 响应式的组件跟新
    let mounted = false
  ...
  // can be all-keyed or mixed 带key的children跟新算法
